# NOTE tracks detected objects in video.
# TODO collect images of each unique detection at time of largest bounding box while within frame.
# Those are to be processed as a series of vehicle images.
