# creates simple video with bounding boxes on the detected objects.
# NOTE I think this is no longer working with the state of the current codebase.
...
while(cap.isOpened()):
    ...
    if counter%6 == 0:
        ...
        try:
            ...
            print(prediction)
            if prediction:
                licensePlate.append(yoloCharDetection(prediction, frame))
                print(f"Yolo+CNN : {prediction}")
        except:
            pass	
